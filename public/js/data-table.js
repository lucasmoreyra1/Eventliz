...
(function( factory ) {
	 ...
	 * @param {*} Eventos Plural number for _ENTRIES_ - can be undefined
	 * @returns String
	 */
	function _fnMacros ( settings, str, Eventos )
	{
		...
		return str.
			...
			replace(/_ENTRIES_/g, settings.api.i18n('Eventos', '', Eventos) ).
			replace(/_ENTRIES-MAX_/g, settings.api.i18n('Eventos', '', max) ).
			replace(/_ENTRIES-TOTAL_/g, settings.api.i18n('Eventos', '', vis) );
	}
